type DeviconReactProps = {
  className: string;
};

export function DeviconReact({ className }: DeviconReactProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 128 128" className={className}>
      <g fill="#61DAFB">
